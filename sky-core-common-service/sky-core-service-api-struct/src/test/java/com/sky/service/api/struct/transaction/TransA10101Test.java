...
public class TransA10101Test {
	public static void main(String[] args) {
		...
		List<TransA10101> body = new ArrayList<TransA10101>();
		body.add(t);
		msg.setHead(head);
		msg.setBody(body);
        ...
        xStream.processAnnotations(TransA10101.class);
...
//		
//		SkyMsg reSerializeMsg = XmlUtils.fromXml(plainMsg, SkyMsg.class, TransA10101.class);
