...
/**
 * Provides utilities for making mock-based tests. Most notable is the generic
 * "type-safe" {@link #createMock(Class)} method, and {@link #replay()} and
 * {@link #verify()} methods that call the respective methods on all created
 * mock objects.
 */
